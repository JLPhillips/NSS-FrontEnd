...
test('Add Order', function(){
  ...
  equal($('#cart tbody tr').length, 0, 'Should not be any rows in tbody after purchase.');
  equal($('#cart-grand').text(), '', 'Should have a blank grand total after purchase.');
  equal($('#select-customer').val(), 'Select Customer', 'Dropdown should default after purchase.');
