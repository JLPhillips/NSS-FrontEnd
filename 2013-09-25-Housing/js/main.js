...
console.log("Number of rooms: " + house.number_of_rooms + ".");
console.log("Number of windows: " + house.number_of_windows + ".");
console.log("Total cost of square footage: $" + house.area_cost + ".");
console.log("Total cost of square footage: $" + house.window_cost + ".");
console.log("Final total: $" + house.total_cost + ".");
